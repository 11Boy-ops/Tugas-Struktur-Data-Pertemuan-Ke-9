...
def visualize_all(app):
    ...
    ax1.text(0.3, 1.35, "⏱️  Chain 1: Chronological View (Doubly Linked List, sorted by date)",
    ...
    ax3.text(0.3, 1.05, "🏷️  Chain 3: Multi-Linked by Tags (Tag Index)",
    ...
    plt.savefig("/mnt/user-data/outputs/advanced_linked_list_visualization.png",
